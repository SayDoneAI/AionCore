...
/// `extra.backend` (e.g. `"claude"`). The built-in Aionrs runtime retains
/// its internal agent type but projects to the SayDone workspace label.
/// Other agent types use their serde name when the backend field is missing
/// or not a string.
