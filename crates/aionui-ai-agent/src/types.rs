...
pub const SAYDONE_MANAGED_AGENT_ENV: &str = "SAYDONE_MANAGED_AGENT";
pub const SAYDONE_MANAGED_BACKEND_ENV: &str = "SAYDONE_MANAGED_BACKEND";
pub const SAYDONE_MANAGED_PROTOCOL_ENV: &str = "SAYDONE_MANAGED_PROTOCOL";
